...
public class BoardGUI extends Stage {
    ...
    public BoardGUI() {
        ...
        if (whoIsConnected == "client1"){
            ...
            board.setOnMouseClicked(e -> {
                ...
                else if (e.getX() > 400 && e.getX() < 600 && e.getY()< 200){//space3
                    Thread getUpdate = new Thread(new Runnable() {
                ...
                else if (e.getX() < 200 && e.getY() < 400 && e.getY() > 200){ //checks if user clicked on space 4.
                    Thread getUpdate = new Thread(new Runnable() {
                ...
                else if (e.getX() > 200 && e.getX() < 400 && e.getY() > 200 && e.getY() < 400){ //checks if user clicked on space 5.
                    Thread getUpdate = new Thread(new Runnable() {
                ...
                else if (e.getX() > 400 && e.getX() < 600 && e.getY() > 200 && e.getY() < 400){ //checks if user clicked on space 6.
                    Thread getUpdate = new Thread(new Runnable() {
                ...
                else if (e.getX() > 0 && e.getX() < 200 && e.getY() > 400 && e.getY() < 600){ //checks if user clicked on space 7.
                    Thread getUpdate = new Thread(new Runnable() {
                ...
                else if (e.getX() > 200 && e.getX() < 400 && e.getY() > 400 && e.getY() < 600){ //on space 8.
                    Thread getUpdate = new Thread(new Runnable() {
                ...
                else if (e.getX() > 400 && e.getX() < 600 && e.getY() > 400 && e.getY() < 600){ // space 9.
                    Thread getUpdate = new Thread(new Runnable() {
        ...
        //player2 stuff...
            ...
            board.setOnMouseClicked(e -> {
                ...
                else if (e.getX() > 400 && e.getX() < 600 && e.getY()< 200){ //checks if user clicked on space 3.
                    Thread getUpdate = new Thread(new Runnable() {
                ...
                else if (e.getX() > 400 && e.getX() < 600 && e.getY() > 200 && e.getY() < 400){//space6
                    Thread getUpdate = new Thread(new Runnable() {
                ...
                else if (e.getX() > 200 && e.getX() < 400 && e.getY() > 400 && e.getY() < 600){ //checks if user clicked on space 8.
                    Thread getUpdate = new Thread(new Runnable() {
                ...
                else if (e.getX() > 400 && e.getX() < 600 && e.getY() > 400 && e.getY() < 600){ //checks if user clicked on space 9.
                    Thread getUpdate = new Thread(new Runnable() {
    ...
    public boolean drawServerSpace(){
    ...
    public boolean drawClientSpace(){
