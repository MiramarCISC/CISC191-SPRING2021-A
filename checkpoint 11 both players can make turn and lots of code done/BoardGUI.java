    ...
    public BoardGUI(String whoIsConnected) {
        ...
        if (whoIsConnected == "server"){
            ...
            new Thread(() -> { // Lambda Expression
                ...
                //turn this into a method that will be called so you dont have to write it every time
                /*
            ...
            board.setOnMouseClicked(e -> {
                if (e.getX() < 200 && e.getY()< 200){//space1
                    ...
                    space2 = server.updateBoardPlayer1(0,0, turn);
                    if (space2){
                        drawSpace2x();
                        turn = turn + 1;
                    }
            ...
            new Thread(() -> { // Lambda Expression
                ...
                //may need to put the thread to sleep here
                space = client.getSpace();
                drawServerSpace();
